...
once installed, simply import the module as normal, and query the docstring via
python -m libRL --help - the docstrings include a list of the available
functions for use. Full documentation is also available at the DocSite, which
is accessible via the DocSite badge above.
